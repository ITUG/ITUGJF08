...
Dieses &quot;s1&quot; stellt keinen eigentlichen Parameter dar, sondern ist ein Stellvertreterzeichen für die noch einzusetzende aktuelle erste Seitenzahl. Die Einsetzung geschieht wie folgt, indem die Datei `$$ PARA0 = "setze_par_s1.tf"` mit OPEN geöffnet und mit CREATE eine leere Datei `$$ PARA = "setze_par.tf"` erzeugt wird. Der Inhalt von `PARA0` wird in eine Datei text ausgelesen, die über einen LOOP satzweise nach dem Vorkommen von &quot;s1&quot; durchsucht und im positiven Fall durch den aktuellen Wert, in unserem Beispiel 11, ersetzt wird. Das Resultat wird in der Parameterdatei `PARA` abgespeichert, die dann im Satzvorgang zur Anwendung kommt. 
